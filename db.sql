...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-08-07 20:10:13
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
(4, '满1000减100', 1000, 100, 1438929000, 1438755900),
...
INSERT INTO `product` (`id`, `name`, `sku`, `category`, `cid`, `bid`, `starttime`, `endtime`, `description`, `short_description`, `time`, `price`, `stock`, `origin`, `label`, `status`, `orderby`, `ship`, `meta_title`, `meta_keywords`, `meta_description`, `activity`) VALUES
(36, '添加的一个商品', '', 24, 0, 0, 1438790400, 1438790400, '', '', 1438835832, 0.00, 0, '中国', '限时热卖', 1, 0, '', '元属性标题', '', '元属性描述', 'seckill'),
(37, '一二三次', '', 31, 0, 2, 1438272000, 1438272000, '', '', 1438654297, 0.00, 0, '', '', 1, 0, '', '', '', '', ''),
(49, '哎呦', '', 0, 0, 2, 0, 0, '', '', 1438682509, 0.00, 0, '', '1', 1, 0, '', '', '', '', ''),
(50, 'abcd', '', 0, 0, 3, 0, 0, '&lt;p&gt;&lt;img src=&quot;http://img.baidu.com/hi/jx2/j_0023.gif&quot; _src=&quot;http://img.baidu.com/hi/jx2/j_0023.gif&quot;/&gt;\n															\n														&lt;/p&gt;', '', 1438708384, 0.00, 0, '', '', 1, 0, '', 'asdfasdf', 'adsfasdf', 'asdfasdf', ''),
(52, '测试用的名字哈', '', 0, 0, 0, 1438704000, 1438704000, '', '', 1438787988, 0.00, 0, '', '1', 1, 0, '', '', '', '', ''),
(53, '啊哈', '', 0, 0, 0, 0, 0, '', '', 1438792278, 0.00, 0, '', '', 1, 0, '', '', '', '', ''),
(54, '哎呦 不错哦', '', 0, 0, 0, 0, 0, '', '', 1438792294, 0.00, 0, '', '1', 0, 0, '', '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `prototype` (
  ...
  `value` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='属性表，异步式属性对接，不要约束' AUTO_INCREMENT=52 ;
...
(4, 48, '长度吗', 'text', '123'),
(26, 36, '重量', 'text', 'cccc'),
(34, 36, '长度', 'radio', 'a:4:{i:0;s:1:"a";i:1;s:1:"b";i:2;s:1:"c";i:3;s:1:"d";}'),
(35, 36, '尺码', 'radio', 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}'),
(39, 49, '好的', 'text', '啊哈哈'),
(43, 50, 'aa', 'text', 'bbb'),
...
INSERT INTO `role` (`id`, `name`, `brand`, `category`, `collection`, `comment`, `product`, `user`, `admin`, `orderlist`, `sale`, `seckill`, `fullcut`) VALUES
(1, '管理员', 15, 15, 0, 0, 15, 15, 15, 15, 15, 15, 15),
(2, '123123', 15, 15, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(3, '123123', 15, 15, 15, 15, 15, 15, 15, 0, 0, 0, 0);
...
(2, 36, 1438942579, 1439028979, 1, 0.00);
...
(16, '98765432101', '', '5aabf397a63deba657f64cebfac61d60', 0, 0, 0.00, 0, 0, '782984', 0, NULL);
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`pid`) REFERENCES `product` (`id`),

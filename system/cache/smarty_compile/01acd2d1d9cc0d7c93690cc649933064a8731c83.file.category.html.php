<?php /* Smarty version Smarty-3.1.16, created on 2015-07-28 10:30:40
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							 <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control input-inline input-medium" placeholder="分类名称">
						...
						<div class="modal-footer">
							<button type="button" class="btn blue">创建</button>
